...
export const  PRODUCT_CITY_LIST_REQUEST = "PRODUCT_CITY_LIST_REQUEST";
export const  PRODUCT_CITY_LIST_SUCCESS = "PRODUCT_CITY_LIST_SUCCESS";
export const  PRODUCT_CITY_LIST_FAIL = "PRODUCT_CITY_LIST_FAIL";