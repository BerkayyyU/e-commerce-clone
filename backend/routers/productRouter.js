...
productRouter.get(
  '/seed', //create products based on data.products
  expressAsyncHandler(async (req, res) => {
    //id should be assigned automatically to the products thats why we remove id from data.js
...
productRouter.get(
  '/:id', //API FOR PRODUCT DETAILS
  expressAsyncHandler(async (req, res) => {
    // returning details of the product to the frontend
